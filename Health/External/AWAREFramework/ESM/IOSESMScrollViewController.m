                        ...
                        if ([[notif.userInfo objectForKey:@"KEY_UPLOAD_SENSOR_NAME"] isEqualToString:SENSOR_PLUGIN_WEB_ESM] ||
                            ...
                            dispatch_async(dispatch_get_main_queue(), ^{
                                ...
                                if( uploadFin == YES && uploadSuccess == YES ){
                                    ...
                                    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Submission succeeded!" message:@"Thank you for your submission." preferredStyle:UIAlertControllerStyleAlert];
...
- (void) addAnESM:(EntityESM *)esm {
    ...
    if (esmType == 1) {
        esmView = [[ESMFreeTextView alloc] initWithFrame:CGRectMake(0, totalHight, self.view.frame.size.width, 44) esm:esm];
